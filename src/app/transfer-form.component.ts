...
@Component({
  selector: 'nx-heavyduty1-transfer-form',
  template: `
    <form class="w-[400px]" #form="ngForm" (ngSubmit)="onSubmit(form)">
      <mat-form-field class="w-full mb-4">
        ...
        @if (form.submitted && tokenControl.errors) {
          ...
          <mat-hint>La moneda que se va a transferir.</mat-hint>
        }
      </mat-form-field>
      ...
      <mat-form-field appearance="fill" class="w-full mb-4">
        ...
        @if (form.submitted && receiverControl.errors) {
          ...
          <mat-hint>Debe ser el destino de la transferencia.</mat-hint>
        }
      </mat-form-field>
      ...
      <mat-form-field appearance="fill" class="w-full mb-4">
        ...
        @if (form.submitted && amountControl.errors) {
          ...
          <mat-hint>Ingresar el monto a enviar.</mat-hint>
        }
      </mat-form-field>
  ...
  `,
  standalone: true,
  imports: [FormsModule, MatButton, MatFormFieldModule, MatSelect, MatOption, MatInput, MatIcon],
})
